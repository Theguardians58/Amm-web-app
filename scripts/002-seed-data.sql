...
INSERT INTO products (id, name, name_hi, description, description_hi, price, original_price, category, sizes, colors, images, image, rating, review_count, is_bestseller, material, material_hi, comfort_level, fabric, hindi_description) VALUES
(
  'prod-1',
  ...
  '100% Organic Cotton',
  '100% ऑर्गेनिक कॉटन',
  9, '100% Organic Cotton',
  'रोज़ाना पहनने के लिए बेहद मुलायम कॉटन बॉडी।'
),
(
  'prod-2',
  ...
  'Cotton Lycra Blend',
  'कॉटन लाइक्रा ब्लेंड',
  8, 'Cotton Lycra Blend',
  'सुंदर लेस-ट्रिम कच्छी 3 के पैक में।'
),
(
  'prod-3',
...
(
  ...
  '100% कॉम्ब्ड कॉटन',
  9, '100% Combed Cotton',
  'वैल्यू 5 पैक में फुल कवरेज हाई-वेस्ट कच्छी।'
),
(
  'prod-6',
  'Sports Comfort Bra',
  ...
  8, 'Polyester Spandex Blend',
  'मॉइश्चर-विकिंग फैब्रिक के साथ स्पोर्ट्स बॉडी।'
),
(
  'prod-7',
  'Cozy Pajama Set',
...
(
  ...
  'नायलॉन स्पैन्डेक्स',
  7, 'Nylon Spandex',
  'सीमलेस कप के साथ टी-शर्ट बॉडी।'
);

-- Seed reviews (using user_name column and text product_id)
INSERT INTO reviews (product_id, user_name, rating, comment, created_at) VALUES
('prod-1', 'Priya M.', 5, 'So comfortable! I wear this every day. The cotton is very soft and breathable.', NOW() - INTERVAL '30 days'),
('prod-1', 'Anita K.', 4, 'Good quality for the price. Wish there were more color options.', NOW() - INTERVAL '20 days'),
('prod-1', 'Fatima S.', 5, 'Best everyday bra I have found. No irritation at all!', NOW() - INTERVAL '10 days'),
('prod-2', 'Rekha D.', 4, 'Nice lace work, comfortable fit. The 3-pack is great value.', NOW() - INTERVAL '25 days'),
('prod-2', 'Sunita P.', 5, 'Beautiful and comfortable. My daughters also loved them!', NOW() - INTERVAL '15 days'),
('prod-3', 'Meena R.', 5, 'Feels so luxurious! The fabric is amazing quality.', NOW() - INTERVAL '22 days'),
('prod-3', 'Kavita L.', 4, 'Very pretty and comfortable. Runs slightly large.', NOW() - INTERVAL '12 days'),
('prod-3', 'Zara N.', 5, 'I bought this as a gift and she absolutely loved it!', NOW() - INTERVAL '5 days'),
('prod-4', 'Pooja T.', 5, 'Perfect matching set. The quality is excellent for the price.', NOW() - INTERVAL '18 days'),
('prod-4', 'Deepa G.', 4, 'Beautiful colors and very comfortable. Highly recommend!', NOW() - INTERVAL '8 days'),
('prod-5', 'Lakshmi V.', 5, 'These are the most comfortable panties I have ever worn. Ordering more!', NOW() - INTERVAL '28 days'),
('prod-5', 'Radha B.', 4, 'Great value pack. Good quality cotton that lasts after many washes.', NOW() - INTERVAL '14 days'),
('prod-6', 'Neha S.', 5, 'Perfect for my morning walks. Great support without discomfort.', NOW() - INTERVAL '16 days'),
('prod-7', 'Aarti M.', 5, 'So soft and cozy! I never want to take these off.', NOW() - INTERVAL '9 days'),
('prod-8', 'Shalini K.', 4, 'Truly seamless - invisible under my t-shirts. Very happy!', NOW() - INTERVAL '7 days');
